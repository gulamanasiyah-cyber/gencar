      ...
      .then((raw) => {
        ...
        const mapped: MemberKegiatan[] = arr.map((k) => {
          ...
          return {
            ...
            tanggalSelesai: k.tanggalSelesai ? String(k.tanggalSelesai) : null,
            jam: String(k.jamMulai || k.jam || "00:00"),
            jamMulai: k.jamMulai ? String(k.jamMulai) : (k.jam ? String(k.jam) : null),
            jamSelesai: k.jamSelesai ? String(k.jamSelesai) : null,
