                                                ...
                                                <div className="occupied-pair">
                                                    <div className="pair-member" style={{ flexDirection: 'column', gap: '2px' }}>
                                                        ...
                                                        <span style={{ fontSize: '10px', color: '#475569', fontWeight: 700 }}>
                                                            Dipanggil: {room.pengirimTotalDipanggil || 0} &bull; Memanggil: {room.pengirimTotalMemanggil || 0}
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div className="pair-member" style={{ flexDirection: 'column', gap: '2px' }}>
                                                        ...
                                                        <span style={{ fontSize: '10px', color: '#475569', fontWeight: 700 }}>
                                                            Dipanggil: {room.penerimaTotalDipanggil || 0} &bull; Memanggil: {room.penerimaTotalMemanggil || 0}
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                <div style={{ background: "#f8fafc", borderRadius: "10px", padding: "14px", marginBottom: "14px", border: "1px solid #e2e8f0" }}>
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                                        <div style={{ flex: 1, textAlign: "center" }}>
                                            ...
                                            <div style={{ fontSize: "11px", color: "#475569", fontWeight: 700, marginTop: "6px", display: "flex", flexDirection: "column", gap: "2px" }}>
                                                <div>Dipanggil: {selectedRoom.pengirimTotalDipanggil || 0}</div>
                                                <div>Memanggil: {selectedRoom.pengirimTotalMemanggil || 0}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div style={{ flex: 1, textAlign: "center" }}>
                                            ...
                                            <div style={{ fontSize: "11px", color: "#475569", fontWeight: 700, marginTop: "6px", display: "flex", flexDirection: "column", gap: "2px" }}>
                                                <div>Dipanggil: {selectedRoom.penerimaTotalDipanggil || 0}</div>
                                                <div>Memanggil: {selectedRoom.penerimaTotalMemanggil || 0}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
