...
export async function GET(request: NextRequest) {
    try {
        ...
        const rooms = await db.select({
            ...
            pengirimTotalMemanggil: sql<number>`(SELECT COUNT(*) FROM mandiri_pemilihan WHERE mandiri_pemilihan.pengirim_id = ${g1.id} AND mandiri_pemilihan.kegiatan_id = ${kegiatanId})`,
            pengirimTotalDipanggil: sql<number>`(SELECT COUNT(*) FROM mandiri_pemilihan WHERE mandiri_pemilihan.penerima_id = ${g1.id} AND mandiri_pemilihan.kegiatan_id = ${kegiatanId})`,
            penerimaTotalMemanggil: sql<number>`(SELECT COUNT(*) FROM mandiri_pemilihan WHERE mandiri_pemilihan.pengirim_id = ${g2.id} AND mandiri_pemilihan.kegiatan_id = ${kegiatanId})`,
            penerimaTotalDipanggil: sql<number>`(SELECT COUNT(*) FROM mandiri_pemilihan WHERE mandiri_pemilihan.penerima_id = ${g2.id} AND mandiri_pemilihan.kegiatan_id = ${kegiatanId})`,
